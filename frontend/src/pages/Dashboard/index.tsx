...
const Dashboard: React.FC = () => {
  ...
  // Calcular total de goles y asistencias
  const totalGoals = topPlayers.topScorers.reduce((sum, player) => sum + (player.goals || 0), 0);
  const totalAssists = topPlayers.topAssisters.reduce((sum, player) => sum + (player.assists || 0), 0);
